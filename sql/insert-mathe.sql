...
VALUES (1, 1, 1, 'Erklärung zur Definition von Punkten und Linien',
        ...
        '../public/img/erklaerung/kurs-1/kapitel-1/gerade.png'),
...
VALUES (1, 1, 1, 'Zeichne zwei Punkte A (2, 3) und B (6, 3) und verbinde sie mit einer Linie.',
        'Nutze ein Lineal, um die Linie gerade zu ziehen.', null),
       (2, 1, 2,
        ...
        '../public/img/aufgaben/kurs-1/kapitel-2/aufgabe-2/winkel.png');
...
VALUES (1, 2, 1,
        ...
        'Addiere den Vektor (3, 2) zu jedem Punkt des Dreiecks.', null),
       (2, 2, 2,
        'Zeichne ein Quadrat mit den Eckpunkten A (0, 0), B (4, 0), C (4, 4), und D (0, 4). Spiegele das Quadrat an der Linie x = 2.',
        'Finde zuerst die Spiegelpunkte, indem du den Abstand zur Spiegelachse berechnest.', null);
...
INSERT INTO AUFGABEN (AUFGABEN_NR, KURS_ID, KAPITEL_NR, AUFGABENSTELLUNG, TIPP, IMG_SRC)
VALUES (1, 4, 1, 'Schreibe die ersten fünf natürlichen Zahlen auf.', 'Denke daran, dass sie bei 1 beginnen.', null),
       (2, 4, 1, 'Welche Zahl ist die kleinste natürliche Zahl?', 'Überlege, ob die Null dazugehört.', null),
       (3, 4, 2,
       ...
       (4, 4, 2, 'Ist die Zahl -7 eine natürliche Zahl oder eine ganze Zahl?',
        'Denke an die Definition der natürlichen Zahlen.', null),
       (5, 4, 3, 'Schreibe drei Beispiele für rationale Zahlen auf.', 'Denke an Brüche wie 1/2 oder 3/4.', null),
       (6, 4, 3, 'Ist die Zahl 0.75 eine rationale Zahl?', 'Überlege, ob sie als Bruch dargestellt werden kann.', null);
...
VALUES (7, 5, 1, 'Gib ein Beispiel für eine irrationale Zahl an.', 'Denke an Wurzeln oder bekannte Konstanten wie π.',
       ...
       (8, 5, 1, 'Kann die Zahl 1.414213... als Bruch dargestellt werden?',
        'Überlege, ob die Dezimaldarstellung periodisch ist.', null),
       (9, 5, 2, 'Gib drei Beispiele für reelle Zahlen an.', 'Dazu gehören rationale und irrationale Zahlen.', null),
       (10, 5, 2, 'Ist die Zahl -√7 eine reelle Zahl?', 'Überlege, ob sie auf der Zahlengeraden liegt.', null);
...
VALUES (11, 6, 1, 'Schreibe eine komplexe Zahl auf, bei der der Realteil 3 und der Imaginärteil 4 ist.',
        'Verwende die Form z = a + bi.', null),
       (12, 6, 1, 'Berechne das Quadrat der imaginären Einheit i.', 'Nutze die Definition von i.', null),
       (13, 6, 2, 'Gib zwei bekannte transzendente Zahlen an.', 'Denke an mathematische Konstanten.', null),
       (14, 6, 2, 'Ist die Zahl √2 transzendent?', 'Überlege, ob sie Lösung einer Polynomgleichung ist.', null);
